...
public:
	...
	static float random_f(const float& _Min, const float& _Max)
	{
		...
		std::uniform_real_distribution<float> disF = std::uniform_real_distribution<float>(_Min, _Max);
		return disF(MT);
	}
	...
	static float random_f(const float& _Max)
	{
		...
		std::uniform_real_distribution<float> disF = std::uniform_real_distribution<float>(.0f, _Max);
		return disF(MT);
	}
	...
	static float random_int(const int& _Min, const int& _Max)
	{
		if (_Min > _Max)
		{
			BBY;
		...
		std::uniform_real_distribution<int> disF = std::uniform_real_distribution<int>(_Min, _Max);
		return disF(MT);
	}

	static float random_int(const int& _Max)
	{
		if (0 > _Max)
		{
			BBY;
		...
		std::uniform_real_distribution<int> disF = std::uniform_real_distribution<int>(.0f, _Max);
		return disF(MT);
	}
