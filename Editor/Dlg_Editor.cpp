...
BOOL Dlg_Editor::OnInitDialog()
{
	...
	KPtr<MeshContainer> MCon = ResourceManager<MeshContainer>::Load((PathManager::Find_ForderPathStr(L"Mesh") + L"BattleTest2.FBX").c_str());
	TestRender->Set_Fbx(L"BattleTest2.FBX");
