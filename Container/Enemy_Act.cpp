...
void Controll_AI::Update_ATTACK()
{
	m_RenderRot.y = m_PlayRot.y + KPI;
}
void Controll_AI::Update_BOMB()
{
	m_RenderRot.y = m_PlayRot.y + KPI;
}
void Controll_AI::Update_HEAL()
{
	m_RenderRot.y = m_PlayRot.y + KPI;
}
void Controll_AI::Update_OPTI()
{
	m_RenderRot.y = m_PlayRot.y + KPI;
}